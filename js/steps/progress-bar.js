...
(function (window) {
  function initProgressBar() {
    ...
    var createStatusBar = function(stages, stageWidth, currentStageIndex) {
      var statusBar = createElement('div', 'status-steps', {width: 100 - stageWidth + '%'}, '');
    ...
    var createCheckPoints = function(stages, stageWidth, currentStageIndex) {
      var ul = createElement('ul', 'progress-steps', { }, '');
      ...
      for (var index = 0; index < stages.length; index++) {
        ...
        if(currentStageIndex >= index) {
          setTimeout(function(li, currentStageIndex, index) {
            //li.className+= (currentStageIndex > index)?'section visited': 'section visited current';
